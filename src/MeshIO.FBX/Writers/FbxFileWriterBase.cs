...
namespace MeshIO.FBX.Writers
{
    internal abstract class FbxFileWriterBase
    {
        ...
        public FbxRootNode ToNodeStructure()
        {
            ...
            {
                this.fbxRoot.Add("FileId", new byte[] { 40, 176, 41, 237, 179, 33, 201, 194, 189, 200, 179, 32, 166, 39, 240, 244 });
                this.fbxRoot.Add("CreationTime", "2023-04-04 20:09:03:229");
                this.fbxRoot.Add("Creator", "MeshIO.FBX");
            }
        ...
        private FbxNode nodeFBXHeaderExtension()
        {
            ...
            if (this.Options.IsBinaryFormat)
            {
                header.Add("EncryptionType", (int)0);
            }
        ...
        private FbxNode nodeDocuments()
        {
            ...
            var props = doc.Add(FbxFileToken.GetPropertiesName(this.Version));
            props.Add("P", "SourceObject", "object", "", "");
            props.Add("P", "ActiveAnimStackName", "KString", "", "", "");

            doc.Nodes.Add(new FbxNode(FbxFileToken.RootNode, Convert.ToInt64(this.RootNode.Id)));
