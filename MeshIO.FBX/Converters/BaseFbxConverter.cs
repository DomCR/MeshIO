...
{
	public class FbxConverter7400 : BaseFbxConverter
	{
		public FbxConverter7400(Scene scene) : base(scene, FbxVersion.v7400) { }
	}

	public abstract class BaseFbxConverter : IFbxConverter
	{
		...
		public BaseFbxConverter(Scene scene, FbxVersion version)
		{
			this._scene = scene;
		...
		protected void buildObjectsNode()
		{
			...
			foreach (Element item in this._scene.Elements)
			{
